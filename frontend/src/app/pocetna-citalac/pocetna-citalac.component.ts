...
@Component({
  selector: 'app-pocetna-citalac',
  templateUrl: './pocetna-citalac.component.html',
  styleUrls: ['./pocetna-citalac.component.css']
})
export class PocetnaCitalacComponent implements OnInit {
